    ...
    <section className="pt-24 pb-16">
      <div className="mx-auto w-full max-w-6xl px-6">
        ...
        >
          <motion.div className="flex flex-col gap-6" variants={item}>
            <div className="space-y-4">
              ...
              <p className="text-balance text-lg text-text-secondary sm:text-xl">
                Railzway extracts billing concerns—usage metering, pricing, subscriptions, and invoicing—into a dedicated, self-hosted engine with explicit boundaries.
              </p>
          ...
          <motion.div
            className="rounded-2xl border border-border-strong bg-bg-primary shadow-2xl p-6"
            variants={item}
          >
